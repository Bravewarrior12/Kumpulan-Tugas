...
public class LionAir extends Tiket{
    ...
    public LionAir(int hrg, int jum_penumpang, String KotaTujuan, String NoPesawat, String NoKursi, String bookID, String nik, String nama, String jns_kelamin, String tglBerangkat, String tglKembali, String kotaAsal) {
     ...
     public void detailTiket () {
        ...
        System.out.println("Jumlah penumpang : " + getJum_penumpang() + " orang" );
